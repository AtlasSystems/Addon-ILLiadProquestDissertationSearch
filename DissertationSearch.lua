...
function Init()
	if GetFieldValue("Transaction", "RequestType") == "Loan" then
		...
		-- Create browser
        browser = interfaceMngr:CreateBrowser("Proquest Dissertation Abstracts", "Proquest Dissertation Abstracts", "Script", "WebView2");
...
function DissertationLoaded()
	...
	browser:ExecuteScript(searchFormScript, {title})
end